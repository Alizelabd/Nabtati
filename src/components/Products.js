          ...
          <Reveal>
            <Card className="rounded-3 h-100 p-2">
              ...
              <Card.Body className="px-0 d-flex flex-column justify-content-between py-3">
                ...
                <Card.Text>
                  نبات صبار صغير مزين بزهور وردية اللون في حوض زجاجي يحتوي على
                  رمل و أحجار ملونة.
                </Card.Text>
                <div className="card-bottom d-flex">
                  <Link
                    to={`/ProdcutPage/1`}
                    className="btn-card flex-fill"
                    variant="primary"
                  >
                    المزيد من التفاصيل
                  </Link>
          ...
          <Reveal>
            <Card className="rounded-3 h-100 p-2">
              ...
              <Card.Body className="px-0 d-flex flex-column justify-content-between py-3">
                ...
                <Card.Text>نبتة الألوفيرا حجم صغير في حوض من الفخار</Card.Text>
                <div className="card-bottom d-flex">
                  <Link
                    to={`/ProdcutPage/2`}
                    className="btn-card flex-fill"
          ...
          <Reveal>
            <Card className="rounded-3 h-100 p-2">
              ...
              <Card.Body className="px-0 d-flex flex-column justify-content-between py-3">
                ...
                <Card.Text>نبتة بونساي حجم صغير في حوض حجري</Card.Text>
                <div className="card-bottom d-flex">
                  <Link
                    to={`/ProdcutPage/3`}
                    className="btn-card flex-fill"
